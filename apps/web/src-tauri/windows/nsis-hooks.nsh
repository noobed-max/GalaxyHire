!macro NSIS_HOOK_PREINSTALL
  DetailPrint "Stopping running GalaxyHire processes before upgrade..."
  nsExec::ExecToLog '"$SYSDIR\taskkill.exe" /IM galaxyhire.exe /T /F'
...
!macro NSIS_HOOK_POSTINSTALL
  DetailPrint "Repairing GalaxyHire Windows install metadata..."
  ...
  DetailPrint "GalaxyHire Windows install metadata repaired."
!macroend
