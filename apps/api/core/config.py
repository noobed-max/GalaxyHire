...
def job_search_brief(cfg: dict | None) -> str:
    """The user's explicit search description, never a phrase inferred from their résumé."""
    cfg = cfg or {}
    preferences = str(cfg.get("job_preferences") or "").strip()
    return preferences or desired_position(cfg)
