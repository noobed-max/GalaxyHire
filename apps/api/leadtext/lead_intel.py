...
def company_from_url(url: str) -> str:
    try:
        ...
        logging.getLogger(__name__).warning('suppressed exception in company_from_url: %s', log_exc)
        host = ""
...
def _role_title_from_url(url: str) -> str:
    try:
        ...
        logging.getLogger(__name__).warning('suppressed exception in _role_title_from_url: %s', log_exc)
        return ""
