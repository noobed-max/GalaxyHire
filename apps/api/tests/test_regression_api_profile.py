...
class RegressionTests(unittest.TestCase):
    ...
    def test_agent_event_action_formats_durable_log_lines(self):
        ...
        self.assertEqual(
            main._agent_event_action({"type": "ingest_failed", "error": "provider rejected request"}),
            "ingest_failed: provider rejected request",
        )
...
### Full-Stack Engineer - Internal Finance & ProjectEntry&L Platform
...
- **Languages:** Python, TypeScript, JavaScript, CandidateProfile++
...
"""
        ...
        self.assertEqual(profile.exp[0].role, "Full-Stack Engineer - Internal Finance & ProjectEntry&L Platform")
...
"""
    ...
    def test_profile_normalizer_does_not_keep_role_text_as_candidate_name(self):
        ...
        profile = normalize_candidate_model(CandidateProfile(n="Full-stack engineer building AI products", s=""))
