...
# Copyright (CandidateProfile) 2026 Vasudev Siddh and vasu-devs
...
def test_normalize_candidate_model_dedupes_experiences():
    from models.schema import CandidateProfile, ExperienceEntry

    model = CandidateProfile(
        n="Jane Doe",
        s="Engineer",
        exp=[
            ExperienceEntry(role="Freelance Engineer", co="Self-employed", period="2024", d="Built a platform.", s=[]),
            ExperienceEntry(role="Freelance Engineer", co="Self-employed", period="2024", d="Built a platform.", s=[]),
            ExperienceEntry(role="Freelance Engineer", co="Self-employed", period="2024", d="Built a platform.", s=[]),
        ],
    )
