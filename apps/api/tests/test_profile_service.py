...
def test_profile_service_ingest_resume_saves_snapshot_fallback(monkeypatch):
    ...
    parsed = CandidateProfile(
        ...
        skills=[SkillEntry(n="Python", cat="technical")],
        exp=[ExperienceEntry(role="Engineer", co="Acme", period="2025", d="Built agents")],
        projects=[ProjectEntry(title="Hiring Agent", stack=["FastAPI", "React"], repo="", impact="Automated matching")],
        education=["B.Tech"],
    )
