...
def _load_profile_deletions(db_path: str | None = None) -> dict[str, list[str]]:
    try:
        ...
        logging.getLogger(__name__).warning('suppressed exception in _load_profile_deletions: %s', log_exc)
        data = {}
...
def _save_profile_deletions(deletions: dict[str, list[str]], db_path: str | None = None) -> None:
    ...
    try:
        ...
        logging.getLogger(__name__).warning('suppressed exception in _save_profile_deletions: %s', log_exc)
        pass
